...
export const GTC_WORLD_CHANGERS_STORIES: GTCWorldChangerStory[] = [
  ...
  },
  {
    ...
    {
    id: 3,
    authorName: 'The Miller Family',
    storyText: 'Our family created a story about a group of animals who work together to clean up their forest home. A wise old owl organized the teams, a strong bear moved heavy logs, and quick squirrels planted new seeds. It taught us that everyone has a role to play in protecting our world.',
  ...
  },
  {
    id: 4,
    authorName: 'Jasmine',
    storyText: 'Luna, a girl with starlight in her hair, found a lost moonbeam sleeping in a flower. She decided to help it find its way back to the night sky.',
    imageUrl: 'https://storage.googleapis.com/maker-me-assets/assets/user-4kP3aIqfT3fL3HKwRTf6Rk01/images/20240529_023812_218151.jpeg',
    musicUrl: 'https://cdn.pixabay.com/download/audio/2022/08/02/audio_89281a0972.mp3',
    category: 'music',
  },
];
